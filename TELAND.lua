...
io.popen("cd library && wget https://raw.githubusercontent.com/UUUsiriaa/tr/main/library/redis.lua") 
...
Namot = (database:get(bot_id..'Name:Bot') or 'انوبيس')
...
os.execute('wget https://raw.githubusercontent.com/UUUsiriaa/tr/main/TELAND.lua')
send(msg.chat_id_, msg.id_,' *⌯︙تم تحديث السورس* \n*⌯︙لديك اخر اصدار لسورس انوبيس*\n*⌯︙الاصدار » { 2.8v}*')
dofile('TELAND.lua')  
end
if text == 'الاصدار ⌯' and DevTELANDW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙اصدار سورس انوبيس* \n*⌯︙الاصدار »{ 2.8v}*')
end
...
send(msg.chat_id_, msg.id_," *⌯︙عذرا الملف لايدعم سورس انوبيس* \n") 
end
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'انوبيس').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'انوبيس')
local TELAND_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'انوبيس').." غادر" or text == 'غادر' then  
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'انوبيس')
